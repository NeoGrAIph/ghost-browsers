...
## Known Gaps / TODO
- [ ] При интеграции с фактическим брокером событий заменить in-memory реализацию
      на транспорт (Redis/Kafka) и расширить тестовое покрытие интеграциями.
...
- 2025-10-03 · ChatGPT — Усилены docstring-и валидаторов и инструкцию дополнили
  требованием фиксировать пропущенные сценарии в `AGENT_NOTES.md` перед
  обратносуместимыми доработками.
